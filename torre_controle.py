...
def load_custom_css():
    ...
    * {{ font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif !important; }}
    ...
    section[data-testid="stSidebar"] [data-testid="stFileUploadDropzone"] {{ background-color: #ffffff !important; border: 3px solid #ffb300 !important; border-radius: 12px !important; box-shadow: none !important; outline: none !important; }}
    section[data-testid="stSidebar"] [data-testid="stFileUploadDropzone"] > * {{ border: none !important; box-shadow: none !important; }}
